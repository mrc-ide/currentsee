...
contact_card <- function(
  ...
  img_el <- if (!is.null(photo)) {
    ...
    shiny::div(class = "card-img-top d-flex align-items-center justify-content-center placeholder",
  ...
  btn <- function(href, icon_name, title, class = "btn btn-sm btn-outline-secondary me-2") {
    ...
    shiny::tags$a(href = href, target = "_blank", class = class, title = title, shiny::icon(icon_name))
  }
