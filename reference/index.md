...
- [`apply_filters()`](https://mrc-ide.github.io/currentsee/reference/apply_filters.md)
  : Apply Filter Selections
- [`calculate_plot_width()`](https://mrc-ide.github.io/currentsee/reference/calculate_plot_width.md)
...
- [`create_coverage_box()`](https://mrc-ide.github.io/currentsee/reference/create_coverage_box.md)
  : Create Coverage Value Box
- [`create_flow_curves()`](https://mrc-ide.github.io/currentsee/reference/create_flow_curves.md)
  : Create detailed flow visualization data with node-based color
  gradients
- [`create_sankey_plot()`](https://mrc-ide.github.io/currentsee/reference/create_sankey_plot.md)
  : Create Sankey Plot
- [`flow_labels`](https://mrc-ide.github.io/currentsee/reference/flow_labels.md)
  : Package flow labels
- [`get_filter_vars()`](https://mrc-ide.github.io/currentsee/reference/get_filter_vars.md)
...
- [`make_flows()`](https://mrc-ide.github.io/currentsee/reference/make_flows.md)
  : Create flow transitions for bidirectional Sankey diagrams
- [`make_nodes()`](https://mrc-ide.github.io/currentsee/reference/make_nodes.md)
...
- [`tab_team()`](https://mrc-ide.github.io/currentsee/reference/tab_team.md)
  : App team tab
- [`validate_current_selection()`](https://mrc-ide.github.io/currentsee/reference/validate_current_selection.md)
